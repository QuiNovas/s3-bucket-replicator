...
lambda_name = 's3-bucket-replicator'
...
lambda_description = 'Replicates all new objects in a source bucket to a configurable number of other buckets'

long_description = 'Replicates all new objects in a source bucket to a configurable number of other buckets'
